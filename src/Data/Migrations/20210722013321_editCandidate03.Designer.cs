...
namespace Data.Migrations
{
    ...
    [Migration("20210722013321_editCandidate03")]
    partial class editCandidate03
    {
            ...
            modelBuilder.Entity("Data.Candidates.Candidate", b =>
                {
                    ...
                    b.Property<string>("WorkCertificate")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Data.Entities.AuthEntities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 7, 22, 2, 33, 18, 661, DateTimeKind.Local).AddTicks(7764),
